        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                modern technologies. From responsive front-ends to robust APIs,
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I leverage strong fundamentals in Data Structures, Algorithms,
                and prompt engineering to solve complex problems efficiently,
                delivering high-quality and optimized solutions.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
